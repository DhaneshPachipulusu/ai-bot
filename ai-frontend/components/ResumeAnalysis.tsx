...
export default function ResumeAnalysis() {
  ...
  async function handleAnalyze() {
    ...
    try {
      ...
      const response = await fetch("https://ai-bot-ikyi.onrender.com/api/analyze-resume", {
        method: "POST",
              ...
              <div className={`border-2 border-dashed rounded-xl p-6 text-center transition-all ${
                ...
                {file ? (
                  <div>
                    ...
                    <p className="text-blue-700 font-medium mt-2">{file.name}</p>
                    <p className="text-xs text-gray-500 mt-1">Click to change</p>
                  </div>
                ) : (
                  <div>
                    <span className="text-2xl">⬆️</span>
                    <p className="text-gray-700 font-medium mt-2">Upload Resume</p>
            ...
            <div className="mb-4">
              ...
              {showJobInput && (
                <textarea
                  ...
                  rows={4}
                  className="mt-2 w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500"
                />
              )}
            </div>
          ...
          {analysis && (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
              ...
              <div className="mt-4 pt-4 border-t">
                ...
                <p className="font-semibold text-gray-900">{analysis.experience_level}</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="lg:col-span-3">
          {!analysis ? (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
              ...
              <p className="text-gray-500">Upload your resume to check ATS compatibility</p>
              
              <div className="mt-8 text-left max-w-md mx-auto">
                <p className="text-sm font-semibold text-gray-700 mb-3">We check for:</p>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className={`w-24 h-24 rounded-full flex items-center justify-center ${
                    analysis.ats_score >= 80 ? "bg-green-100" : 
                    analysis.ats_score >= 60 ? "bg-yellow-100" : "bg-red-100"
                  }`}>
              ...
              {analysis.ats_checks && analysis.ats_checks.length > 0 && (
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                  <h3 className="font-bold text-gray-900 mb-4">ATS Compatibility Checks</h3>
                    ...
                    {analysis.ats_checks.map((check, idx) => (
                      <div
                        ...
                        className={`flex items-center justify-between p-3 rounded-lg ${
                          ...
                          check.priority === "critical" ? "bg-red-50" : "bg-yellow-50"
                        }`}
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className={`font-medium text-sm ${check.passed ? "text-green-800" : "text-gray-800"}`}>
                              {check.name}
                            </p>
                            {!check.passed && (
                        ...
                        {!check.passed && (
                          <span className={`text-xs px-2 py-0.5 rounded ${
                            check.priority === "critical" ? "bg-red-200 text-red-800" : "bg-yellow-200 text-yellow-800"
                          }`}>
                            {check.priority}
                          </span>
                        )}
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="bg-yellow-50 rounded-2xl border border-yellow-200 p-6">
                  <h3 className="font-bold text-yellow-800 mb-3">⚡ Quick Fixes</h3>
                  <ul className="space-y-2">
